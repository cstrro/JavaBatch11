...
public abstract class Task1 {
	...
	public static void main(String[] args) {
		...
		/*
		 * Write a Java program to ass, subtract, multply, and divide 2 decimal values. Your program should say "The__ of 2 numbers__ and__ is equal to__"
		 */
